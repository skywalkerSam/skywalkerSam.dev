...
export function NavigationMenuBar() {
  return (
    <div className="flex">
      ...
      <div className="flex size-12 flex-grow tracking-tighter sm:tracking-tight md:tracking-normal">
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <Link href="/"><NavigationMenuTrigger>Home</NavigationMenuTrigger></Link>
              <NavigationMenuContent>
                <ul className="grid p-4 md:w-[300px]">
